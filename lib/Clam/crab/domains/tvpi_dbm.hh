...
using BASE(fixed_tvpi_dbm_domain_t) = fixed_tvpi_domain<BASE(split_dbm_domain_t)>;
using fixed_tvpi_dbm_domain_t = RGN_FUN(ARRAY_FUN(BOOL_NUM(BASE(fixed_tvpi_dbm_domain_t))));
} // end namespace clam
