...
def parseArgs(argv):
    ...
    p.add_argument('--dsa-partial-collapse', default=False, action='store_true',
                         dest='dsa_partial_collapse',
                         help='Allows DSA node to partially collapsed')
    p.add_argument('--dsa-lazy-mem-transfer', default=False, action='store_true',
                         dest='lazy_mem_transfer',
                         help='Enable lazy memory transfer optimization')
    ...
    p.add_argument('--crab-dom',
                    help="Choose abstract domain:\n"
                          ...
                          "- fixed-tvpi-dbm: zones domain for TVPI with fixed coefficients\n"
